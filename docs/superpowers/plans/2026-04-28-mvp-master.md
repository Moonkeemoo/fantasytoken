...
| --------------------------------------------------------------------------------------- | ---------------------------------------------------------------------- | ------------------- |
| **S0 Foundation** — Drizzle schemas, CurrencyService, /me upsert, admin auth, FE router | [`2026-04-28-mvp-s0-foundation.md`](./2026-04-28-mvp-s0-foundation.md) | 🟢 ready to execute |
| **S1 Catalog+Lobby** — CoinGecko sync, /tokens, /contests, Lobby UI                     | _to be written when S0 merged_                                         | 🔴                  |
| **S2 Team Builder** — /tokens/search, /entries, builder UI                              | _to be written when S1 merged_                                         | 🔴                  |
