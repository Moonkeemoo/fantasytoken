...
export function Rankings() {
  ...
  // PnL is mode-neutral cash net by definition; one ranking by total earnings
  // is the universal leaderboard metric. Backend's `?mode=` query is left in
  // place for any future per-mode views (Profile already uses Best Bull/Bear).
